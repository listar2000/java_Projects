...
public class CardGameGUI extends JFrame implements ActionListener {
	...
	private void initDisplay()	{
		...
		System.out.println("another play:"+board.anotherPlayIsPossible());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(replaceButton)) {
			...
			System.out.println(board.isLegal(selection));
			...
			if (board.isEmpty()) {
				...
				System.out.println("position2:"+!board.anotherPlayIsPossible());
				signalLoss();
			}
			repaint();
