...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  /** 25% zoom level */
  private JMenu nextPic;
  
  private JMenuItem selectPic;
  ...
  private void setUpMenuBar()
  {
    ...
    selectPic = new JMenuItem("select");
    ...
    selectPic.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent evt) {
			...
			JFileChooser chooser = new JFileChooser("Open another picture");
			chooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
			chooser.showOpenDialog(null);
			try {
			String selectedFile = chooser.getSelectedFile().getPath();
			
			if (selectedFile != null && selectedFile.endsWith(".jpg"));
				Picture newPic = new Picture(selectedFile);
				newPic.explore();
			}
...
//    Picture p2 = pix.scale(0.3, 0.3);
//    p2.write("src/images/smallpic.jpg");
  }
